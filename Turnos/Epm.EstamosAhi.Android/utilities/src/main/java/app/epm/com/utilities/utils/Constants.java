...
public final class Constants {
    ...
    public static final String PACKAGE_NAME_TO_NOTIFICATIONS = "packageNameFromIntent";
    ...
    public static final String CUSTOMER_SERVICE = "DashboardCustomerServiceActivity";
    ...
    public static final String TEMP_IMAGE_DAMAGE_FRAUDE = "localEvidenceImage";
    ...
    public static final int TYPE_SUBSCRIPTION_ALERTAS_TEST = 99;
    ...
    public static final String TURN_SERVICE_PACKAGE = "turn.views";
    public static final String PROCEDURE_SERVICE_PACKAGE = "procedure.views";
    ...
    public static final String TEXT_SOON_TOU_WILL_SEE_MORE_INFORMATION_ABOUT_PROCEDURES = "Pronto verás aquí la información de más trámites";

    public static final String NUMBER_LOCAL_MEDELLIN_CITY = "(034) 4444 115";
    public static final String NUMBER_OUTSIDE_MEDELLIN_CITY = "01 8000 415 115";
    public static final String NUMBER_PROGRAM_WE_ARE = "(034) 4444 800";
    public static final String NUMBER_TRANSPARENT_CONTACT = "01 8000 522 955";
    ...
    public static final String FAST_TRANSACTION = "fast_transaction";
    public static final String CALL_SINCE_SHIFT_INFORMATION = "callSinceShiftInformation";
    public static final String ID_TRANSACTION = "idTransaction";

    public static final String ID_LINE_ATTENTION = "C1";
    public static final String ID_VISIT_OFFICE = "C2";
    public static final int ZOOM_LEVEL_GENERAL_OFFICE = 80;
