...
import com.epm.app.di.module.transactions.ActivityModuleTransactions;
import com.epm.app.di.module.transactions.RespositoryModuleTransactions;
...
@Component(modules = {
        ...
        ActivityModuleTransactions.class,
        ...
        RespositoryModuleTransactions.class
})
