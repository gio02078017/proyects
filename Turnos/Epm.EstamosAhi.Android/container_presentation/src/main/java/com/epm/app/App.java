...
public class App extends MultiDexApplication implements ICustomApplicationContext, HasActivityInjector, HasServiceInjector, HasFragmentInjector {
    ...
    private void loadClassesName() {
        ...
        customSharedPreferences.addString(Constants.ATTENDED_SHIFT, DashboardCustomerServiceActivity.class.getName());
        ...
        customSharedPreferences.addString(Constants.CUSTOMER_SERVICE, DashboardCustomerServiceActivity.class.getName());
