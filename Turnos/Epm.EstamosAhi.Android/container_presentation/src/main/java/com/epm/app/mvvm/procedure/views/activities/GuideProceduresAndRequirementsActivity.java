...
public class GuideProceduresAndRequirementsActivity extends BaseActivityWithDI implements GuideProceduresAndRequirementsCategoryRecyclerAdapter.OnGuideProceduresAndRequirementsCategoryRecyclerListener {
    ...
    private void loadBinding() {
        ...
        guideProceduresAndRequirementsViewModel.getExpiredToken().observe(this, errorMessage -> showAlertDialogUnauthorized(errorMessage.getTitle(),errorMessage.getMessage()) );
        loadService();
    ...
    public void onItemClick(int position) {
        ...
        procedureInformation.setIdService(guideProceduresAndRequirementsViewModel.getItemGuideProceduresAndRequirementsCategory(position).getCategoryId());
