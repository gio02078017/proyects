...
public class OfficeDetailViewModel extends BaseViewModel implements IOfficeDetailViewModel {
    ...
    public final MutableLiveData<Integer> textSeeProcessingRequirements;
    ...
    private MutableLiveData<StateMessage<java.io.Serializable>> turnOpenedState;
    ...
    private MutableLiveData<ProcedureInformation> liveDataProcedureInformation;
    ...
    public OfficeDetailViewModel(TurnServicesRepository turnServicesRepository,
        ...
        textSeeProcessingRequirements = new MutableLiveData<>();
    ...
    public void initComponents() {
        ...
        textSeeProcessingRequirements.setValue(View.GONE);
    }
    ...
    public void validateStateTurn(String stateOffice) {
        switch (stateOffice) {
            ...
            case Constants.STATE_SHIFT_CANCELED:
                ...
                break;
            default:
                turnOpenedState.setValue(stateMessage);
                break;
        }
    }
    ...
    public void validateTurn(Turno turno, Oficina oficina) {
        if (turno != null && controlShiftInformation) {
            drawSuccessTurn(turno, oficina);
            validateStateTurn(turno.getEstadoDeTurno());
            validateProcedure(turno);
        }
    }

    public void validateProcedure(Turno turno){
        if(turno.getIdTramite() != null){
            textSeeProcessingRequirements.setValue(View.VISIBLE);
            liveDataProcedureInformation.setValue(new ProcedureInformation(turno.getIdServicio(), turno.getIdTramite(), turno.getDetalleMaestros()));
        }
    }
    ...
    @Override
    public MutableLiveData<StateMessage<Serializable>> getTurnOpenedState() {
        return turnOpenedState;
    }
    ...
    @Override
    public MutableLiveData<ProcedureInformation> getLiveDataProcedureInformation() {
        return liveDataProcedureInformation;
    }
    ...
    public boolean isControlShiftInformation() {
        return controlShiftInformation;
    }

    public void setControlShiftInformation(boolean controlShiftInformation) {
        this.controlShiftInformation = controlShiftInformation;
    }
}
