...
public class LandingActivity extends BaseActivity<LandingPresenter> implements ILandingView, HasSupportFragmentInjector, INotificationObserver.IShift {
    ...
    private CardView landing_ivTransaction;
    ...
    private void validateRequestCode(){
        actionResult(getIntent().getIntExtra("token",Constants.DEFAUL_REQUEST_CODE));
    ...
    private void actionResult(int resultCode){
        switch (resultCode) {
    ...
    private void loadViews() {
        ...
        landing_ivTransaction = (CardView) findViewById(R.id.landing_ivTransaction);
    ...
    private void loadListenerToTheControls() {
        ...
        loadClickListenerToTheControlLandingIvTransition();
    ...
    private void loadClickListenerToTheControlLandingIvTransition() {
        landing_ivTransaction.setOnClickListener(view -> onClickListenerToTheControlLandingIvTransition());
    }
    ...
    private void loadOnClickListenerToTheControlLandingIvFacturaWeb() {
        landing_ivFacturaWeb.setOnClickListener(view -> onClickListenerToTheControlLandingIvFacturaWeb());
    }
    ...
    private void onClickListenerToAttendedShift() {
        Intent intent = new Intent(getApplication(), DashboardCustomerServiceActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivityWithOutDoubleClick(intent);
    }
    ...
    private void onClickListenerToTurnAdvance() {
        ...
        if (informationOffice != null){
            ...
            intent = new Intent(this, DashboardCustomerServiceActivity.class);
        }
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivityWithOutDoubleClick(intent);
    }
    ...
    private void onClickListenerToTheControlLandingIvServicioAlCliente() {
        Intent intent = new Intent(LandingActivity.this, DashboardCustomerServiceActivity.class);
        startActivityWithOutDoubleClick(intent);
    }
    ...
    private void onClickListenerToTheControlLandingIvTransition() {
        if (getPresenter().checkExecutionInAndroidApiActualVersion()) {
            Intent intent = new Intent(LandingActivity.this, TransactionListActivity.class);
            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivityWithOutDoubleClick(intent);
        } else {
            // TODO : Adds message without permission
