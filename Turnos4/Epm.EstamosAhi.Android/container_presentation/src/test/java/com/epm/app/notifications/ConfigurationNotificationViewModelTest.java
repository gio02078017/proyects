...
public class ConfigurationNotificationViewModelTest {
    ...
    public void testValidateErrorIs401(){
        ...
        int error= R.string.text_unauthorized;
        ValidateServiceCode.captureServiceErrorCode(Constants.UNAUTHORIZED_ERROR_CODE);
        configurationNotificationViewModel.validateError(titleError,error);
        assertEquals(titleError,configurationNotificationViewModel.getIntTitleError());
        assertEquals(error,configurationNotificationViewModel.getMessageError());
        assertEquals(true, configurationNotificationViewModel.getExpiredToken().getValue());
    }
    ...
    public void testValidateErrorIsOtherCode(){
        ...
        assertEquals(titleError,configurationNotificationViewModel.getIntTitleError());
        assertEquals(error,configurationNotificationViewModel.getMessageError());
        assertEquals(true, configurationNotificationViewModel.getIsError().getValue());
    }
