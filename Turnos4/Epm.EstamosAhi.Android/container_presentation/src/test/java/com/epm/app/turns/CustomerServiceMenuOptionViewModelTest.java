...
public class CustomerServiceMenuOptionViewModelTest {
    ...
    public void setUp() throws Exception {
        ...
        customerServiceMenuOptionViewModel.jsonStringRepository = jsonStringRepository;
    ...
    public void getCustomerServiceMenuNull() {
        ...
        assertNull(customerServiceMenuOptionViewModel.getListCustomerServiceMenu().getValue());
    }
    ...
    public void getCustomerServiceMenuNoNull() {
        ...
        when(jsonStringRepository.getDataMenu()).thenReturn(customerServiceMenu);
        customerServiceMenuOptionViewModel.getCustomerServiceMenu();
        assertNotNull(customerServiceMenuOptionViewModel.getListCustomerServiceMenu().getValue());
    }
}