...
public class NotificationCenterViewModelTest {
    ...
    public void testValidateErrorCodeService401(){
        ...
        notificationCenterViewModel.validateError();
        assertEquals(true,notificationCenterViewModel.getExpiredToken().getValue());
    }
    ...
    public void testValidateErrorCodeServiceOtherError(){
        ...
        notificationCenterViewModel.validateError();
        assertEquals(true, notificationCenterViewModel.getIsError().getValue());
    }
