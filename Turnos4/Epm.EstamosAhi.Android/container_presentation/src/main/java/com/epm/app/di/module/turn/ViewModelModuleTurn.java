...
public abstract class ViewModelModuleTurn {
    ...
    @Binds
    @IntoMap
    @ViewModelKey(CustomerServiceMenuOptionViewModel.class)
    abstract ViewModel bindCustomerServiceMenuOptionViewModel(CustomerServiceMenuOptionViewModel customerServiceMenuOptionViewModel);
