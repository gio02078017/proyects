...
public class PrivacyPolicyActivity extends BaseActivityWithDI {
    ...
    private void loadBinding(){
        ...
        privacyPolicyViewModel.getExpiredToken().observe(this, aBoolean -> {
            if(aBoolean != null && aBoolean){
                showAlertDialogUnauthorized(privacyPolicyViewModel.getError().getValue().getTitle(),privacyPolicyViewModel.getErrorUnauthorized());
            }
        });
