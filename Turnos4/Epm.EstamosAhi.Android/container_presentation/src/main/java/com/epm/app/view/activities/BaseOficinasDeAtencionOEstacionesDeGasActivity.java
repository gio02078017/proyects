...
public abstract class BaseOficinasDeAtencionOEstacionesDeGasActivity extends BaseActivityWithDI{
    ...
    private void showDialogNotInternet(){
        getCustomAlertDialog().showAlertDialog(getName(), R.string.text_validate_internet, false, R.string.text_intentar, (dialogInterface, i) -> validateInternetToLoadMap(), R.string.text_cancelar, (dialogInterface, i) -> finish(), null);
    }

    private void loadViews() {
        toolbarApp = (Toolbar) findViewById(R.id.toolbar);
        baseMap_frameLayoutArcgisMap = (FrameLayout) findViewById(R.id.baseMap_frameLayoutArcgisMap);
        base_imageView_location = (ImageView) findViewById(R.id.base_imageView_location);
        loadToolbar();
    }
        ...
        Glide.with(getApplicationContext())
                ...
                .into(new GlideDrawableImageViewTarget(binding.imageOffice) {
                    ...
                    public void onLoadFailed(Exception e, Drawable errorDrawable) {
                        binding.progressBarOffice.setVisibility(View.GONE);
                        binding.imageOffice.setImageResource(R.mipmap.icon_oficina_por_defecto);
                    }
                });
    }
    ...
    public void showMessageSettings()
    {
        try {
            getCustomAlertDialog().showAlertDialog(app.epm.com.utilities.R.string.title_recommend_giving_permissions, app.epm.com.utilities.R.string.text_recommend_giving_permissions, false, app.epm.com.utilities.R.string.text_go_to_settings, (dialog, which) -> {
                ...
                startActivityForResult(new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS, Permissions.uriApp(getApplicationContext())),Constants.ACTION_TO_TURN_ON_PERMISSION);
    ...
    private void drawWithTurn(double latitud, double longitud){
        ...
        base_mapView.setViewpointGeometryAsync(initialEnvelope, 50);
    }
