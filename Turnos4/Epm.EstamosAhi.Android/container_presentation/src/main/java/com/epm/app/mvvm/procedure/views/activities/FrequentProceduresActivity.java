...
public class FrequentProceduresActivity extends BaseActivityWithDI implements FrequentProceduresAdapter.OnFrequentProceduresRecyclerListener {
    ...
    private void listenLiveData() {
        ...
        frequentProceduresViewModel.getExpiredToken().observe(this, aBoolean -> showAlertDialogUnauthorized(frequentProceduresViewModel.getError().getValue().getTitle(), frequentProceduresViewModel.getErrorUnauthorized()));
    ...
    private String getCategoryId() {
        return Objects.requireNonNull(procedureInformation.getGuideProceduresAndRequirementsCategoryItem().getCategoryId());
    }
    ...
    public void onItemClick(int position) {
        ...
        procedureInformation.setProcedure(frequentProceduresViewModel.getProcedure(position));
