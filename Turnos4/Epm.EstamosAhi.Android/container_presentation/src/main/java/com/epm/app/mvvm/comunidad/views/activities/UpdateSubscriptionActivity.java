...
public class UpdateSubscriptionActivity extends BaseActivityWithDI {
    ...
    private void loadBinding() {
        ...
        updateSubscriptionViewModel.getExpiredToken().observe(this, aBoolean -> {
            showAlertDialogUnauthorized(updateSubscriptionViewModel.getError().getValue().getTitle(),updateSubscriptionViewModel.getErrorUnauthorized());
        });
