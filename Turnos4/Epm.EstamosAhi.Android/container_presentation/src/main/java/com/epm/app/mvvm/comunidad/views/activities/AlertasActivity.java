...
public class AlertasActivity extends BaseActivityWithDI {
    ...
    private void loadBinding() {
        ...
        alertasViewModel.getExpiredToken().observe(this, aBoolean -> showAlertDialogUnauthorized(alertasViewModel.getError().getValue().getTitle(), alertasViewModel.getErrorUnauthorized()));
