...
public class RecuperationSubscriptionActitity extends BaseActivityWithDI {
    ...
    private void loadViewModel(){
        ...
        binding.getRecuperationViewModel().getExpiredToken().observe(this, aBoolean -> {
            showAlertDialogUnauthorized(recuperationViewModel.getError().getValue().getTitle(),recuperationViewModel.getErrorUnauthorized());
        });
