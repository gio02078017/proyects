 ...
 */
public class ListViewExpandible extends ExpandableListView {
    /*
    ...
    public ListViewExpandible(Context context) {
        super(context);
    }

    public ListViewExpandible(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ListViewExpandible(Context context, AttributeSet attrs, int defStyle) {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private ListViewExpandible parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(ListViewExpandible parent) {
            this.parent = parent;
        }
        ...
        public final View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, final ViewGroup parent) {
            ...
            if (info.animating) {
                ...
                travelForFirstChildPosition(convertView, info, groupPosition);
        ...
        private void travelForFirstChildPosition(View convertView, final GroupInfo info, final int groupPosition) {
