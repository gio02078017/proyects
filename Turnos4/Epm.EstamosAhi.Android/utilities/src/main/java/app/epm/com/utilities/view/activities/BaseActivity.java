...
public class BaseActivity<T extends BasePresenter> extends AppCompatActivity implements IBaseView, ICustomNotificationHelper, INotificationObserver {
    ...
    public void manageActionTurnAdvance() {
        try {
            ...
            if (informationOffice != null) {
                ...
                goToTheActivity(Constants.ATENTION_CHANNEL);
            }
