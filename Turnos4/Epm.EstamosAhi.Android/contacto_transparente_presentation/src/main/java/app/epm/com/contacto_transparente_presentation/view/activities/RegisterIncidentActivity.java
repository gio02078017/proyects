...
public class RegisterIncidentActivity extends BaseActivity implements DatePickerDialog.OnDateSetListener,
    ...
    private void loadListener() {
        ...
        describe_etPlace.setOnClickListener(view -> customAlertDialogInputData.showAlertDialogInputData(window, inflater, RegisterIncidentActivity.this, R.string.text_tv_location, describe_etPlace, describe_etPlace.getText().toString(), 200));
        describe_etDescription.setOnClickListener(view -> customAlertDialogInputData.showAlertDialogInputData(window, inflater, RegisterIncidentActivity.this, R.string.text_tv_description, describe_etDescription, describe_etDescription.getText().toString(), 5000));
        describe_etPeople.setOnClickListener(view -> customAlertDialogInputData.showAlertDialogInputData(window, inflater, RegisterIncidentActivity.this, R.string.text_tv_name_people_involved, describe_etPeople, describe_etPeople.getText().toString(), 500));
        describe_etCompany.setOnClickListener(view -> customAlertDialogInputData.showAlertDialogInputData(window, inflater, RegisterIncidentActivity.this, R.string.text_tv_incident_company, describe_etCompany, describe_etCompany.getText().toString(), 500));
