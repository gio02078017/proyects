...
namespace GrupoExito.Test.NotificationsModelTest
{
    public class BaseNotificationsModelTest
    {
        ...
        public BaseNotificationsModelTest()
        {
            ...
            Model = new NotificationsModel(Service.Object);
