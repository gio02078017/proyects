...
{
    public partial class DetailRecipeOfTheDaySoruce : UITableViewSource
    {
        #region Attributtes
        ...
        public DetailRecipeOfTheDaySoruce(List<RecipeDetail> Recipes, IList<string> Ingredients, IList<string> Preparations)
        {
